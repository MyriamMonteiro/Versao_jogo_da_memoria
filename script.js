...
const cardImages = [
    './assets/img/bolo1.0.png',
    './assets/img/milho1.0.png',
    './assets/img/pipoca1.0.png',
    './assets/img/canjica1.0.png',
    './assets/img/pizza1.0.png',
    './assets/img/quentao1.0.png',
    './assets/img/chocolate1.0.png',
    './assets/img/batata-doce1.0.png',
];
...
function initializeGame() {
    ...
    cardsArray.forEach(card => {
        ...
        backFace.src = './assets/img/cerebro.png';
